...
const AdminDashboard = () => {
    ...
    // Sirf Approve aur Reject - No Block/Unblock
    ...
    return (
        <div className="admin-dashboard-layout">
            ...
            <main className="admin-main-content">
                            ...
                            {customersList.length === 0 ? (
                                ...
                                <div className="table-responsive">
                                    <table className="admin-master-table">
                                        <thead>
                                            <tr>
                                                <th>Customer ID</th><th>Name</th><th>Email Address</th><th>Phone Number</th><th>Status</th><th>Action</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                ...
                {/* TAB 3: Sellers System Management - Sirf Approve/Reject, No Block/Unblock */}
                    ...
                    <div className="admin-tab-content animate-fade">
                        ...
                        <div className="admin-doc-vault-container">
                            ...
                            <div className="seller-submitted-info-grid">
                                <div className="info-box-item"><span>1. Owner Name:</span> <b>{reviewingSellerDocs.documents.ownerName}</b></div>
                                <div className="info-box-item"><span>2. Store/Shop Name:</span> <b>{reviewingSellerDocs.documents.storeName}</b></div>
                                <div className="info-box-item"><span>3. Mobile Number:</span> <b>{reviewingSellerDocs.documents.mobile}</b></div>
                                <div className="info-box-item"><span>4. Gmail Address:</span> <b>{reviewingSellerDocs.documents.email}</b></div>
                                <div className="info-box-item"><span>5. PAN Number:</span> <b style={{ fontFamily: "monospace" }}>{reviewingSellerDocs.documents.panNumber}</b></div>
                                <div className="info-box-item"><span>6. GSTIN Number:</span> <b style={{ fontFamily: "monospace" }}>{reviewingSellerDocs.documents.gstin}</b></div>
                                <div className="info-box-item"><span>7. Bank Account:</span> <b style={{ fontFamily: "monospace" }}>{reviewingSellerDocs.documents.bankAccount}</b></div>
                                <div className="info-box-item"><span>8. Bank IFSC Code:</span> <b style={{ fontFamily: "monospace" }}>{reviewingSellerDocs.documents.ifscCode}</b></div>
                            </div>
                    ...
                    <div className="admin-tab-content animate-fade">
                        ...
                        {selectedSellerHelp && (
                            <div className="admin-section-card animate-fade" style={{ marginTop: "20px", borderLeft: "4px solid #0f172a", background: "#f8fafc" }}>
                                <h4 style={{ margin: "0 0 10px 0" }}>📨 Full Message Body From Merchant: <u>{selectedSellerHelp.store}</u></h4>
                    ...
                    <div className="admin-tab-content animate-fade">
                        ...
                        {selectedCustHelp && (
                            <div className="admin-section-card animate-fade" style={{ marginTop: "20px", borderLeft: "4px solid #2563eb", background: "#f8fafc" }}>
                                <h4 style={{ margin: "0 0 10px 0" }}>📨 Full Grievance Notes From Consumer: <u>{selectedCustHelp.name}</u></h4>
                                <div style={{ background: "white", padding: "15px", borderRadius: "6px", border: "1px solid #cbd5e1", fontSize: "0.9rem", lineHeight: "1.5", color: "#334155" }}>
